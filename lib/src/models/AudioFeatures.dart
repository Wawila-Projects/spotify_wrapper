...
class AudioFeatures {
  ...
  ///the track is acoustic. 1.0 represents high
  ///confidence the track is acoustic.
  double acousticness;

  ///An HTTP URL to access the full audio analysis of
  ///this track. An access token is required to access this data.
  String analysisUrl;
  ...
  SpotifyType type = SpotifyType.AudioFeatures;
